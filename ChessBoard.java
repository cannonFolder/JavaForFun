...
public class ChessBoard 
{
  ...
  void init()
  {
    ...
    //board.put(new Point(4,0), new Chessman(Country.RED, Unit.JIANG));
    ...
    //demo RED_BING
    board.put(new Point(4,1), new Chessman(Country.BLACK, Unit.BING));
}
  ...
  */
  void move(int fromX, int fromY, int toX, int toY)
  {
    if(haveChess(fromX, fromY) && isMoveValid(fromX, fromY, toX, toY))
    {
      ...
      {
        //System.out.println("movesuccesful");
        board.put(new Point(toX, toY), fromChess);
        board.remove(new Point(fromX, fromY));
      }
    }
  ...
  boolean isWin(int fromX, int fromY, int toX, int toY) 
  {
    ...
    if(chessman.getCountry() == Country.RED)
    { 
      //System.out.println("enter country == red");
      //System.out.println(fromX+" "+fromY+" "+toX+" "+toY);
      //System.out.println(chessman.getUnit()+ " "+chessman.getCountry());
      //System.out.println(board.containsValue(BLACK_JIANG));
      return !(board.containsValue(BLACK_JIANG));
    }
    if(chessman.getCountry() == Country.BLACK)
    {
      //System.out.println("enter country == black");
      //System.out.println(fromX+" "+fromY+" "+toX+" "+toY);
      //System.out.println(chessman.getUnit()+ " "+chessman.getCountry());
